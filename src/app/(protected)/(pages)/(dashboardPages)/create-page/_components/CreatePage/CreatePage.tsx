      ...
      >
        {CreatePageCard.map((option) => (
          <motion.div
            ...
            className={`${
              option.highlight
                ? "bg-vivid-gradient border-vivid "
                : "hover:bg-vivid-gradient "
            }rounded-xl p-[1px] transition-all duration-300 ease-in-out shadow-white `}
          >
            <motion.div
            ...
            >
              ...
              >
                <Button
                  ...
                  className={` ${
                    option.highlight ? "hover:bg-slate-500" : ""
                  }w-fit rounded-xl font-bold bg-slate-200 text-black`}
                  size={"sm"}
