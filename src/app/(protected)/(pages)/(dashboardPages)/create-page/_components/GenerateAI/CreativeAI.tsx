  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="text-center space-y-2">
        ...
        <p className="text-slate-300">What would like to create today?</p>
      </motion.div>
      <motion.div
        className="bg-slate-300/10 p-4 rounded-xl"
      ...
      <div className="w-full flex justify-center items-center ">
        <Button
          className="font-medium  text-lg flex gap-2 items-center dark:bg-white dark:text-black"
      ...
      {outlines.length > 0 && (
        <Button
          className="w-full text-white bg-zinc-600"
