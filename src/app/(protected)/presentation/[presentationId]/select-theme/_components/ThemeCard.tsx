      ...
      >
        <div className="flex flex-col md:flex-row">
          ...
          <div className="relative w-full md:w-1/2 h-80 md:h-auto overflow-hidden rounded-r-lg">
            <Image
              src={
                "https://plus.unsplash.com/premium_photo-1677346804541-d4e58f7c02a1?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwyN3x8fGVufDB8fHx8fA%3D%3D"
              }
