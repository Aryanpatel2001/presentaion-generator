...
const ThemePicker = ({ onThemeSelect, selectedTheme }: Props) => {
  ...
  const handleGenerateLayouts = async () => {
    ...
    try {
      ...
      if (res.status !== 200 && !res?.data) {
        throw new Error("Failed to generate layouts a a  a");
      }
  ...
  return (
    <div
      className="w-[400px] overflow-hidden sticky top-0 h-screen flex-col flex"
      style={{
        backgroundColor:
    ...
    >
      ...
      <ScrollArea className="flex-grow px-8 p-8">
